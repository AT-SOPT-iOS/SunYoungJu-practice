...
extension ChatModel {
    static func dummy() -> [ChatModel] {
        return [
            ...
            ChatModel(profileImg: .profile2, name: "김한열", place: "뭘보슈", message: "생일추카", itemImg: .product1),
            ChatModel(profileImg: .profile3, name: "선영주", place: "문정", message: "안녕하세요", itemImg: .product3),
        ]
    }
}
